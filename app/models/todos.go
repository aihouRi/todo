...
// GetTodosByUser gets a user information with specified ID
...
// UpdateTodo updates a todo information with specified ID
...
// DeleteTodo deletes a todo information with specified ID
